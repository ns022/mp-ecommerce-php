...
$preference->back_urls = array(
    'failure' => $URL_RETURN_FAILURE,
    'pending' => $URL_RETURN_PENDING,
    'success' => $URL_RETURN
);

$preference->payment_methods = array(
    "excluded_payment_methods" => array(array("id" => "visa")
),
"installments" => 6
);

$preference->binary_mode = true;
$preference->notification_url = "https://web-develop.com.ar/mp-ecommerce-php/notification.php";
$preference->external_reference = "ns022@hotmail.com";
                        ...
                        <div class="as-accessories-results  as-search-desktop">
                            <div class="width:60%">
                                ...
                                <div class="as-producttile-info" style="float:left;min-height: 168px;">
                                    ...
                                    <?php echo "<a class='mercadopago-button' href='$preference->init_point'>Pagar </a>";?>
