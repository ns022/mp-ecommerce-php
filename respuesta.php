                    ...
                    <div class="as-accessories" id="as-accessories">
                        ...
                        <div class="as-accessories-results  as-search-desktop" style="text-align: center;">
                            <div class="width:100%" style="text-align: center;">
                                           ...
                                           <h3 class="as-producttile-name" style="text-align: center;">
                                            <?php 
                                            switch($data['id']){
                                                case "failure":
                                                    echo "<h1>El pago fue rechazado</h1>";
                                                    break;
                                                case "pending":
                                                    echo "<h1>El pago está siendo procesado</h1>";
                                                    break;
                                                case "success":
                                                    echo "<h1>Gracias!</h1><p>Su compra fue exitosa. En breve recibirá un correo electrónico con más instrucciones.</p>";
                                                    echo "</p>      ".$_GET['id'];
                                                    echo "</p>payment_id:".$_GET['payment_id'];
                                                    echo "</p>external_reference:".$_GET['external_reference']."</h2>";
                                                    break;
                                            }?>     
        ...
        <div class="as-footnotes ">
            <div class="as-footnotes-content">
                <div class="as-footnotes-sosumi">
                    Todos los derechos reservados Tienda Tecno  
                </div>
            </div>
        </div>
